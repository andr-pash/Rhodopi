$('document').ready(function() {
    ...
    var imgSrc = [
        './img/carousel/Slice1.png',
        './img/carousel/Slice2.png',
        './img/carousel/Slice3.png',
        './img/carousel/Slice4.png',
        './img/carousel/Slice5.png',
        './img/carousel/Slice6.png',
        './img/carousel/Slice7.png',
    ]
    ...
    var carouselNodes = imgSrc.map( function(el, i) {
        ...
        return $('<div></div>').appendTo($('#carousel .carousel__list'))
                .addClass('carousel__item')
                .addClass(carouselClasses[index])
